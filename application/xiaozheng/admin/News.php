...
class News extends Admin
{
	...
	public function look($id=''){
		...
		return ZBuilder::make('form')
			->setPageTitle('查看动态信息详情') // 设置页面标题
			//->setPageTips('以下是动态信息的详细容') // 设置页面提示信息
	...
	public function edit($id=''){
		...
		if ($id>0) {
			...
			return ZBuilder::make('form')
				...
				->addImage('pic_id', '图片','',$news['pic_id'])
				...
				->addUeditor('content', '内容','',$news['content'])
